...
class EnRefreshString implements RefreshString {
  ...
  @override
  String canRefreshText = "Thả để tải lại";
  ...
  @override
  String idleRefreshText = "Kéo xuống để tải lại";
  ...
  @override
  String noMoreText = "Hết dữ liệu";

  @override
  String refreshCompleteText = "Tải lại thành công";

  @override
  String refreshFailedText = "Tải lại thất bại";

  @override
  String refreshingText = "Đang tải lại…";
}
