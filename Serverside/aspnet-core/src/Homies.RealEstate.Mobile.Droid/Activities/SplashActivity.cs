...
using Homies.RealEstate.Localization.Resources;
using Homies.RealEstate.ViewModels.Base;
using Plugin.Connectivity;
using Process = Android.OS.Process;

namespace Homies.RealEstate.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<RealEstateXamarinAndroidModule>();
