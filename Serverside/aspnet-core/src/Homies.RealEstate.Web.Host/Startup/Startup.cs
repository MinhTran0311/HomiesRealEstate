...
using Homies.RealEstate.Web.Chat.SignalR;
using Homies.RealEstate.Web.Common;
using Swashbuckle.AspNetCore.Swagger;
using Homies.RealEstate.Web.IdentityServer;
using Homies.RealEstate.Web.Swagger;
using Stripe;
...
using Homies.RealEstate.Web.HealthCheck;
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Homies.RealEstate.Web.wwwroot.swagger.ui.index.html");
