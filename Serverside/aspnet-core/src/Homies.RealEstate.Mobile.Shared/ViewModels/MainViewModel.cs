...
using Homies.RealEstate.Commands;
...
using Homies.RealEstate.Controls;
using Homies.RealEstate.Dto;
using Homies.RealEstate.Extensions;
using Homies.RealEstate.Localization;
using Homies.RealEstate.UI;
using Homies.RealEstate.UI.Assets;
using Homies.RealEstate.Views;
using DependencyResolver = Homies.RealEstate.Core.Dependency.DependencyResolver;
...
namespace Homies.RealEstate.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "RealEstate";
