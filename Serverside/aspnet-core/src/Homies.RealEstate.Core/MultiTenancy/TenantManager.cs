...
using Homies.RealEstate.MultiTenancy.Demo;
...
namespace Homies.RealEstate.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(RealEstateConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(RealEstateConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
