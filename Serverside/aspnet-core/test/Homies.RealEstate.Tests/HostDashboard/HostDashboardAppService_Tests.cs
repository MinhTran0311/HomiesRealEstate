...
using Homies.RealEstate.MultiTenancy.HostDashboard;
...
namespace Homies.RealEstate.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(RealEstateDbContext context, SubscriptionPayment subscriptionPayment)
        {
